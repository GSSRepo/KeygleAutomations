// import { addressAnswer } from './dispoForm-js.js'


// console.log(addressAnswer);

// const dispoForm = localStorage.getItem("D09sw9v3pb");

// const dispoForm = localStorage.getItem("dkem1q3td");

// console.log(JSON.parse(dispoForm));
...
// filterForm.addEventListener('click', filterStats);
...
//Buyer Selection
    if (dataRows[1] === "Wholesaler") {
     wholesaler.checked = true;
        }
        else if (dataRows[1] === "Agent") {
             agent.checked = true;
        }
        else if (dataRows[1] === "Investor") {
