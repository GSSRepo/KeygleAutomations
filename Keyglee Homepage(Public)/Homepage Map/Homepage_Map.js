...
var height = 250; 
        ...
        const bedDetails = document.createElement('p');
          ...
          "<img src='" + dataRows[14] + "'height='250px' width='320px' style='padding-bottom: 25px;'>" +
          ...
          "<a href=" + dataRows[12] + "class='listTitle' style='font-weight: 600; font-size: 17px; font-style: italic; margin-left: 15px;' id='propPhotos'>Property Photos</a>" +
